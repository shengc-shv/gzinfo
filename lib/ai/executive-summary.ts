...
1. must_read（今日必读，3-5 条）：**只挑宏观级/市场级大信号**——全国性重大政策转向、市场重大变化、行业性新趋势、全新的产品/玩法（如"算力Token贷"这类市场全新产品推出）。它回答"今天发生了什么值得分行领导思考怎么与经营规划挂钩"。每条：
...
2. insights（商机提示，3-5 条）：**与必读错开主题**，只放"看到即可安排人跟进处置"的具体商机/风险（获客动作/产品配置/风险处置），**不放宏观大信号**（宏观归 must_read）。每条：
   - topic：主题（15 字内）
