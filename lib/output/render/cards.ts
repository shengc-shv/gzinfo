...
// 2026-09-11 补「获」变体（IPO获受理 / IPO获问询）：主流媒体常用「XX科创板IPO获受理」表述，
// 原 `IPO已?受理` 只覆盖「已受理/受理」而漏掉「获受理」，导致真实 IPO 流程条目被 P0-3 内容闸门误丢。
export const IPO_PROGRESS_RE =
  /注册生效|同意注册|IPO注册|首次公开发行|过会|上会|上市委|提交注册|注册申请|辅导备案|IPO辅导|辅导验收|招股|申购|路演|敲钟|新股上市|递表|拟上市|发行审核|发行注册|注册制上市|IPO(已|获)?受理|IPO(已|获)?问询/;
