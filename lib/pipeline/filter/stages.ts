 ...
 *
 * 漏斗一 业务相关性（本链，今日新增）：single-institution + stock-single + keyword-funnel
...
/** 过滤 stage 顺序数组（3 漏斗整改：删冗余 Stage6、归位 Stage8、漏斗三回退为每源限额、删除相关性闸门 relevanceGate；漏斗一 = single-institution + stock-single + keyword-funnel，与 2026-08-31 午间版一致；最终 7 道，收敛为 3 漏斗）。 */
